    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, validators=[django.core.validators.RegexValidator(message='Phone number must be in format +1234567890 or 123-456-7890', regex='^(\\+\\d{10,15}|\\d{3}-\\d{3}-\\d{4})$')])),
            ],
        ),
        migrations.CreateModel(
            name='Product',
